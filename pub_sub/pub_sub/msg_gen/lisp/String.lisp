...
(cl:defmethod cl:initialize-instance :after ((m <String>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'String)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pub_sub-msg:<String> is deprecated: use pub_sub-msg:String instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <String>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pub_sub-msg:data-val is deprecated.  Use pub_sub-msg:data instead.")
  (data m))
